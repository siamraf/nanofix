...
public final class FixStreamMessageParserTest
{
    ...
    @Test
    public void shouldParseMessageFragmentedAtFixMessageStartCodecBoundary()
    {
    ...
    public void shouldParseFragmentedMessageWhichHasIncompleteMessagePrefixAtEnd()
    {
        ...
        ByteBuffer inputStream1 = ByteBuffer.wrap(part1);
        ByteBuffer inputStream2 = ByteBuffer.wrap(part2);
        ByteBuffer inputStream3 = ByteBuffer.wrap(part3);
    ...
    public void shouldParseMessageSegmentContainingNeitherCompleteStartPrefixNorEndSuffix() throws Exception
    {
        ...
        ByteBuffer inputStream2 = ByteBuffer.wrap(part2);
        ByteBuffer inputStream3 = ByteBuffer.wrap(part3);
        ByteBuffer inputStream4 = ByteBuffer.wrap(part4);
        ByteBuffer inputStream5 = ByteBuffer.wrap(part5);
        ByteBuffer inputStream6 = ByteBuffer.wrap(part6);
        ByteBuffer inputStream7 = ByteBuffer.wrap(part7);
        ByteBuffer inputStream8 = ByteBuffer.wrap(part8);
